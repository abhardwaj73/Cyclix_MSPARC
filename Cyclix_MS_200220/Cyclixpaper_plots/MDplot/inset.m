...
%set(h_inset,'Position', [.2*ax(1)+ax(3)-inset_size .5*ax(2)+ax(4)-inset_size inset_size inset_size])
set(h_inset,'Position', [.65*ax(1)+1.0*ax(3)-inset_size .5*ax(2)+ax(4)-inset_size inset_size inset_size])
