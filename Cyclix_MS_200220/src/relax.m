...
%======================================================================
	...
	if (S.RelaxFlag == 1 || S.RelaxFlag == 2) && S.elecgs_Count == 1
...
%===================================================================================================
	...
	[x,r,S] = electronicGroundState(x,S); r = -r;
	...
	while (i<imax && err>tol1)
		...
		[~,r_temp,S] = electronicGroundState(x+sigma_0*S.NLCG_d,S);
		S.elecgs_Count = S.elecgs_Count + 1;
		...
		while ((j < jmax) && (abs(alph)*delta_d > tol2))
			...
			x = x + alph * S.NLCG_d;
			[x,r_temp,S] = electronicGroundState(x,S);
			S.elecgs_Count = S.elecgs_Count + 1;
			eta_prev = eta;
			j = j + 1;
...
%================================================================================
	...
	[X,G,S] = electronicGroundState(X,S); F = -G;
	S.elecgs_Count = S.elecgs_Count + 1;
...
%==========================================================================================
	...
	[x_var,force_fun,S] = electronicGroundState(x_var,S); Force_var = -force_fun;
	S.elecgs_Count = S.elecgs_Count + 1;
