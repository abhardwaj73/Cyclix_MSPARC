function [x] = AAR_old(A,b,x_guess,tol,max_iter,beta,m,p,PC)
...
if isempty(m)
    m = 7;                   % Anderson history, no. of previous iterations to be considered in extrapolation
end
if isempty(p)
    p = 4;                    % Perform Anderson extrapolation at every p th iteration
end
if isempty(PC)
    PC = 2;                   % No preconditioning
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
